...
import com.yeahka.dexshadow.builder.Apk;
...
public class DexShadow {
    ...
    private static Apk parseOptions(String[] args){
        ...
        options.addOption(new Option(Const.OPTION_ONLY_JIAGU,Const.OPTION_ONLY_JIAGU_LONG,false,"only jiagu apk."));
        options.addOption(new Option(Const.OPTION_ONLY_CHANNEL_PACK,Const.OPTION_ONLY_CHANNEL_PACK_LONG,false,"only channel pack."));
        options.addOption(new Option(Const.OPTION_ROTATE_SIGN,Const.OPTION_ROTATE_SIGN_LONG,false,"rotate sign."));
        ...
        try {
            ...
            return new Apk.Builder()
                    ...
                    .onlyJiagu(commandLine.hasOption(Const.OPTION_ONLY_JIAGU))
                    .onlyChannel(commandLine.hasOption(Const.OPTION_ONLY_CHANNEL_PACK))
                    .rotateSign(commandLine.hasOption(Const.OPTION_ROTATE_SIGN))
                    .build();
        }
    ...
    private static void usage(Options options){
        ...
        helpFormatter.printHelp("java -jar dexShadow.jar [option] -f <apk>",options);
    }
}
